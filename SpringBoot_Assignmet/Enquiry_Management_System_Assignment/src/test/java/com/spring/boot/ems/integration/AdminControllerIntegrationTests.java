...
import com.spring.boot.ems.controller.AdminController;
...
import com.spring.boot.ems.service.UserRoleService;
...
import static com.spring.boot.ems.CustomSecurityMockMvcRequestPostProcessors.latiDude;
import static com.spring.boot.ems.CustomSecurityMockMvcRequestPostProcessors.latiTest;
...
public class AdminControllerIntegrationTests {
 ...
 //   @WithMockUser(username = "namdev@gmail.com", password = "0011100", roles = "APPADMIN") // latiDude
 //   @WithMockUser(username = "namdevtest@gmail.com", password = "1100011", roles = "ADMIN") //latiTest
 //   @Sql(scripts = "/admin-controller-integration-test_2_add_user.sql", executionPhase = BEFORE_TEST_METHOD)
    public void adminControllerTest_1() throws Exception {
        ...
        mockMvc.perform(get("/admin").with(csrf()).with(latiDude())) // latiDude = APPADMIN
                ...
                .andExpect(model().attribute("currentUser",
                        Matchers.hasProperty("email", Matchers.containsString("namdev@gmail.com"))))
                .andExpect(model().attribute("currentUser",
                        Matchers.hasProperty("roles", Matchers.hasItem(Matchers.<UserRole>hasProperty(
    ...
    public void adminControllerTest_3() throws Exception {
        ...
        assertTrue(userRepository.findByEmail("namdevtest@gmail.com").isEnabled(), "test ADMIN disabled");
    }
    ...
    public void adminControllerTest_5() throws Exception {
        ...
        User userToUpdateADMIN = userRepository.findByEmail("namdevtest@gmail.com");
        ...
        mockMvc.perform(post("/user/block").with(csrf()).with(demo()) // demo() = USER
                ...
                .andExpect(model().attribute("users",
                        Matchers.hasItem(Matchers.<User>hasProperty("email",
                                Matchers.equalToIgnoringCase("namdevtest@gmail.com")))));

        // after blocking attempt
        assertFalse(userRepository.findByEmail("namdevtest@gmail.com").isBlocked(), "test ADMIN blocked");
    }
    ...
    public void adminControllerTest_8() throws Exception {
        ...
        userToUpdateADMIN = userRepository.findByEmail("namdevtest@gmail.com");
    ...
    public void adminControllerTest_9() throws Exception {
        ...
        User userToUpdateAPPADMIN = userRepository.findByEmail("namdev99@gmail.com");
        ...
        userToUpdateAPPADMIN = userRepository.findByEmail("namdev@gmail.com");
    ...
    public void adminControllerTest_11() throws Exception {
        ...
        User userToResetAPPADMIN = userRepository.findByEmail("namdev@gmail.com");
        ...
        userToResetAPPADMIN = userRepository.findByEmail("namdev@gmail.com");
    ...
    public void adminControllerTest_13() throws Exception {
        ...
        User userToActivateAPPADMIN = userRepository.findByEmail("namdev@gmail.com");
        ...
        // after activation, USER
        userToActivateAPPADMIN = userRepository.findByEmail("namdev@gmail.com");
        assertNull(userToActivateAPPADMIN.getActivationToken(), "activation token not null");
    }
