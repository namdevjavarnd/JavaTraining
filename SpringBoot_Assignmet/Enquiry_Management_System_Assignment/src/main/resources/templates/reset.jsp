...
<!-- Password change confirmation/rejection (incorrect link) -->
<body>
    ...
    <div class="container" style="margin-top:30px">
        <div class="row">
            ...
            <div class="col-sm-10 border border-default border-top-0 border-right-0 border-bottom-0">
                ...
                <div class="mt-2" th:if="${reset == null}">


                    <div class="mt-2" th:if="${invalidToken != null}">
                        <div class="alert alert-danger mb-3" style="text-align:center">
                            <button type="button" class="close" data-dismiss="alert">&times;</button>
                            <span>The password reset link is either incorrect or expired.</span>
                        </div>
                        <div class="alert alert-warning mb-3" style="text-align:center">
                            <button type="button" class="close" data-dismiss="alert">&times;</button>
                            <span>Please ask a System Administrator to re-send the password reset link.</span>
                        </div>
                    </div>
                    ...
                    <div class="mt-2" th:if="${invalidToken == null}">
                        ...
                        <form action="#" th:action="@{/user/resetForm}" method="post" th:object="${user}">
                            ...
                            <div class="form-group">
                                ...
                                <span class="ml-5" id="form-errors" th:if="${#fields.hasErrors('password')}"
                                      th:errors="*{password}">
                  --passwords errors--</span>
