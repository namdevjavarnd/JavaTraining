...
<!-- Displayed when submitting enquiry succeeds -->
<body>
        ...
        <div class="row">
            ...
            <div class="col-sm-9 border border-default border-top-0 border-right-0 border-bottom-0">
                ...
                <div>
                    ...
                    <div class="alert alert-primary mb-5" style="text-align:center">
                        <button type="button" class="close" data-dismiss="alert">&times;</button>
                        <span>Your enquiry has been successfully submited! We will get back to you shortly.</span>
                    </div>

                    <a href="/" class="btn btn-outline-info btn-block ml-sm-2" role="button">Back to Enquiry Form</a>
